...
<div class="container-fluid">
    <div class="row bg-secondary py-1 px-xl-5">
        <div class="col-lg-6 d-none d-lg-block">
            <div class="d-inline-flex align-items-center h-100">
                ...
                <a class="text-body mr-3" href="/Help">Help</a>
                <a class="text-body mr-3" href="/faq">FAQs</a>
                <a class="text-body mr-3" href="/admin/index">Admin</a>
            </div>
        </div>
            ...
            <div class="d-inline-flex align-items-center">
                <div class="btn-group">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        ...
                        <a class="dropdown-item" href="/login" role="button">Sign in</a>
                        <a class="dropdown-item" href="/register" role="button">Sign up</a>
                        <?php else: ?>
                            <li><a href="/profile">Profile</a></li>
                            <a class="dropdown-item" href="/profile" role="button">Profile</a>
                            <a class="dropdown-item" href="/logout" role="button">Logout</a>
                            <li><a href="/logout">Welcome <?php echo Application::$app->user->getDisplayName() ?>
                                    (Logout)</a>
                            </li>
                        <?php endif; ?>
                    </div>
    ...
    <div class="row align-items-center bg-light py-5 px-xl-7 d-none d-lg-flex">
        <div class="col-lg-4">
